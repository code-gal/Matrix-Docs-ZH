...
[here](Synapse%20Docs%20-%20EN/setup/installation.md#using-postgresql).
...
See [here](Synapse%20Docs%20-%20EN/modules/index.md) for more
...
See [here](Synapse%20Docs%20-%20EN/delegate.md)
...
See [Delegation of incoming federation traffic](Synapse%20Docs%20-%20EN/delegate.md) for more
information.
...
[module API](Synapse%20Docs%20-%20EN/modules/index.md).
...
See the docs [request log format](Synapse%20Docs%20-%20EN/usage/administration/request_log.md).
...
* `type`: the type of listener. Normally `http`, but other valid options are:
   ...
   * `manhole`: (see the docs [here](Synapse%20Docs%20-%20EN/manhole.md)),

   * `metrics`: (see the docs [here](Synapse%20Docs%20-%20EN/metrics-howto.md)),

* `tls`: set to true to enable TLS for this listener. Will use the TLS key/cert specified in tls_private_key_path / tls_certificate_path.

* `x_forwarded`: Only valid for an 'http' listener. Set to true to use the X-Forwarded-For header as the client IP. Useful when Synapse is
   behind a [reverse-proxy](Synapse%20Docs%20-%20EN/reverse_proxy.md).
...
* `request_id_header`: The header extracted from each incoming request that is
   ...
   [logs](Synapse%20Docs%20-%20EN/usage/administration/request_log.md#request-log-format) and tracing to
   ...
   a [reverse-proxy](Synapse%20Docs%20-%20EN/reverse_proxy.md).
...
* `consent`: user consent forms (/_matrix/consent). See [here](Synapse%20Docs%20-%20EN/consent_tracking.md) for more.
...
* `metrics`: the metrics interface. See [here](Synapse%20Docs%20-%20EN/metrics-howto.md). (Not compatible with Unix sockets)

* `openid`: OpenID authentication. See [here](Synapse%20Docs%20-%20EN/openid.md).

* `replication`: the HTTP replication API (/_synapse/replication). See [here](Synapse%20Docs%20-%20EN/workers.md).

* `static`: static resources under synapse/static (/_matrix/static). (Mostly useful for 'fallback authentication'.)

* `health`: the [health check endpoint](Synapse%20Docs%20-%20EN/reverse_proxy.md#health-check-endpoint). This endpoint
  ...
  for [workers](Synapse%20Docs%20-%20EN/workers.md) and containers without listener e.g.
  [application services](Synapse%20Docs%20-%20EN/workers.md#notifying-application-services).
...
on the manhole [here](Synapse%20Docs%20-%20EN/manhole.md). Manhole sub-options include:
...
[here](Synapse%20Docs%20-%20EN/templates.md) for more information.
...
See [Monthly Active Users](Synapse%20Docs%20-%20EN/usage/administration/monthly_active_users.md) for details on how to configure MAU.
...
See [here](Synapse%20Docs%20-%20EN/templates.md) for more
...
about this feature [here](Synapse%20Docs%20-%20EN/message_retention_policies.md).
...
* `cache_autotuning` and its sub-options `max_cache_memory_usage`, `target_cache_memory_usage`, and
   ...
   usage and cache entry availability. You must be using [jemalloc](Synapse%20Docs%20-%20EN/usage/administration/admin_faq.md#help-synapse-is-slow-and-eats-all-my-ramcpu)
...
* `allow_unsafe_locale` is an option specific to Postgres. Under the default behavior, Synapse will refuse to
  ...
  [here](Synapse%20Docs%20-%20EN/postgres.md#fixing-incorrect-collate-or-ctype) and [here](https://wiki.postgresql.org/wiki/Locale_data_changes).
...
see [here](Synapse%20Docs%20-%20EN/postgres.md).
...
See [here](Synapse%20Docs%20-%20EN/reverse_proxy.md) for more on using a reverse proxy with Synapse.
...
[quarantined](Synapse%20Docs%20-%20EN/admin_api/media_admin_api.md#quarantining-media-in-a-room)
will not be deleted. Similarly, local media that has been marked as
[protected from quarantine](Synapse%20Docs%20-%20EN/admin_api/media_admin_api.md#protecting-media-from-being-quarantined)
will not be deleted.
...
See [here](Synapse%20Docs%20-%20EN/CAPTCHA_SETUP.md) for full details on setting up captcha.
...
Tokens can be managed using the admin [API](Synapse%20Docs%20-%20EN/usage/administration/admin_api/registration_tokens.md).
...
(see [Registering a user](Synapse%20Docs%20-%20EN/setup/installation.md#registering-a-user));
...
and login. See [here](Synapse%20Docs%20-%20EN/openid.md)
   ...
   sub-properties:
     ...
     * `module`: The class name of a custom mapping module. Default is
       `synapse.handlers.oidc.JinjaOidcMappingProvider`.
        See [OpenID Mapping Providers](Synapse%20Docs%20-%20EN/sso_mapping_providers.md#openid-mapping-providers)
...
See [here](Synapse%20Docs%20-%20EN/jwt.md) for more.
...
* `search_all_users`: Defines whether to search all users visible to your homeserver at the time the search is performed.
   ...
   If false, search results will only contain users
    ...
    [for running background updates](Synapse%20Docs%20-%20EN/usage/administration/admin_api/background_updates.md#run),
...
For detailed instructions on user consent configuration, see [here](Synapse%20Docs%20-%20EN/consent_tracking.md).
...
Settings for local room and user statistics collection. See [here](Synapse%20Docs%20-%20EN/room_and_user_statistics.md)
for more.
...
* `homeserver_whitelist`: The list of homeservers we wish to send and receive span contexts and span baggage.
   See [here](Synapse%20Docs%20-%20EN/opentracing.md) for more.
...
For guidance on setting up workers, see the [worker documentation](Synapse%20Docs%20-%20EN/workers.md).
...
Unnecessary to set if using [`pusher_instances`](#pusher_instances) with [`generic_workers`](Synapse%20Docs%20-%20EN/workers.md#synapseappgeneric_worker).

Controls sending of push notifications on the main process. Set to `false`
if using a [pusher worker](Synapse%20Docs%20-%20EN/workers.md#synapseapppusher). Defaults to `true`.
...
and email by running a [`generic_worker`](Synapse%20Docs%20-%20EN/workers.md#synapseappgeneric_worker) and adding it's [`worker_name`](#worker_name) to
...
Unnecessary to set if using [`federation_sender_instances`](#federation_sender_instances) with [`generic_workers`](Synapse%20Docs%20-%20EN/workers.md#synapseappgeneric_worker).

Controls sending of outbound federation transactions on the main process.
Set to `false` if using a [federation sender worker](Synapse%20Docs%20-%20EN/workers.md#synapseappfederation_sender).
Defaults to `true`.
...
by running a [`generic_worker`](Synapse%20Docs%20-%20EN/workers.md#synapseappgeneric_worker) and adding it's [`worker_name`](#worker_name) to
...
declared under [`stream_writers`](Synapse%20Docs%20-%20EN/workers.md#stream-writers) and
...
[worker documentation](Synapse%20Docs%20-%20EN/workers.md#stream-writers).
...
Also see the [](Synapse%20Docs%20-%20EN/workers.md#restrict-outbound-federation-traffic-to-a-specific-set-of-workers)
for more info.
...
The [worker](Synapse%20Docs%20-%20EN/workers.md#background-tasks) that is used to run
...
The [worker](Synapse%20Docs%20-%20EN/workers.md#updating-the-user-directory) that is used to
...
The [worker](Synapse%20Docs%20-%20EN/workers.md#notifying-application-services) that is used to
...
The [worker](Synapse%20Docs%20-%20EN/workers.md#synapseappmedia_repository) that is used to run
...
in [worker documentation](Synapse%20Docs%20-%20EN/workers.md#available-worker-applications).

The most common worker is the
[`synapse.app.generic_worker`](Synapse%20Docs%20-%20EN/workers.md#synapseappgeneric_worker).
...
A worker may have a listener for [`manhole`](Synapse%20Docs%20-%20EN/manhole.md).
