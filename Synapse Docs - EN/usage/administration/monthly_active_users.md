...
Please note that the metrics recorded by the [Homeserver Usage Stats](Synapse%20Docs%20-%20EN/usage/administration/monitoring/reporting_homeserver_usage_statistics.md)
...
See the [configuration manual](Synapse%20Docs%20-%20EN/usage/configuration/config_documentation.md#limit_usage_by_mau) for details on how to configure MAU.
