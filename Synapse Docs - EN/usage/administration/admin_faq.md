...
[User Admin API](Synapse%20Docs%20-%20EN/admin_api/user_admin_api.md#change-whether-a-user-is-a-server-administrator-or-not)
...
If you uses [Poetry](Synapse%20Docs%20-%20EN/development/dependencies.md#managing-dependencies-with-poetry)
to run Synapse:
...
can reset a user's password using the [admin API](Synapse%20Docs%20-%20EN/admin_api/user_admin_api.md#reset-password).
...
You can also use the [List Room API](Synapse%20Docs%20-%20EN/admin_api/rooms.md#list-room-api)
...
This is normally caused by a misconfiguration in your reverse-proxy. See [the reverse proxy docs](Synapse%20Docs%20-%20EN/reverse_proxy.md) and double-check that your settings are correct.
...
with a [PostgreSQL database](Synapse%20Docs%20-%20EN/postgres.md).
...
in the Synapse config file: [see here](Synapse%20Docs%20-%20EN/usage/configuration/config_documentation.md#presence).
