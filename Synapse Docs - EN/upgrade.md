...
-   If Synapse was installed using [prebuilt packages](Synapse%20Docs%20-%20EN/setup/installation.md#prebuilt-packages),
...
[Media repository workers](Synapse%20Docs%20-%20EN/workers.md#synapseappmedia_repository) handling
...
[`on_threepid_bind`](Synapse%20Docs%20-%20EN/modules/third_party_rules_callbacks.md#on_threepid_bind)
"third-party rules" Synapse module callback method in favour of a new module method,
[`on_add_user_third_party_identifier`](Synapse%20Docs%20-%20EN/modules/third_party_rules_callbacks.md#on_add_user_third_party_identifier).
...
[`on_remove_user_third_party_identifier`](Synapse%20Docs%20-%20EN/modules/third_party_rules_callbacks.md#on_remove_user_third_party_identifier)
...
[Background update Admin API](Synapse%20Docs%20-%20EN/usage/administration/admin_api/background_updates.md#status).
...
In line with our [deprecation policy](Synapse%20Docs%20-%20EN/deprecation_policy.md), we've dropped
...
To migrate to Redis add the [`redis` config](Synapse%20Docs%20-%20EN/workers.md#shared-configuration),
...
In line with our [deprecation policy](Synapse%20Docs%20-%20EN/deprecation_policy.md),
...
See [using a forward proxy with Synapse documentation](Synapse%20Docs%20-%20EN/setup/forward_proxy.md) for
details.
...
to [this documentation](Synapse%20Docs%20-%20EN/modules/porting_legacy_module.md)
to update their modules. Synapse administrators can refer to [this documentation](Synapse%20Docs%20-%20EN/modules/index.md)
...
to update their modules. Synapse administrators can refer to [](Synapse%20Docs%20-%20EN/modules/index.md)
to update their configuration once the modules they are using have been updated.
...
The [v2 list accounts API](Synapse%20Docs%20-%20EN/admin_api/user_admin_api.md#list-accounts)
...
See the [reverse proxy documentation](Synapse%20Docs%20-%20EN/reverse_proxy.md), where the
...
-   If your server is configured for single sign-on via an OpenID
    ...
    See the [OpenID docs](Synapse%20Docs%20-%20EN/openid.md) for more information on setting
    up OpenID Connect.
...
The [reverse proxy documentation](Synapse%20Docs%20-%20EN/reverse_proxy.md)
...
Additionally, note that the [Synapse worker documentation](Synapse%20Docs%20-%20EN/workers.md) has been updated to
...
2.  The easiest workaround for this issue is to manually create a new
    ...
    Synapse admins are reminded that [](Synapse%20Docs%20-%20EN/postgres.md).
...
See [Postgres](Synapse%20Docs%20-%20EN/postgres.md) for details.
...
See the [sample configuration file](Synapse%20Docs%20-%20EN/usage/configuration/homeserver_sample_config.md)
...
See [](Synapse%20Docs%20-%20EN/metrics-howto.md#renaming-of-metrics--deprecation-of-old-names-in-12)
for details.
