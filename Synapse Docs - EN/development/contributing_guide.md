...
Synapse's code style is documented [here](Synapse%20Docs%20-%20EN/code_style.md). Please follow
it, including the conventions for [](Synapse%20Docs%20-%20EN/code_style.md#configuration-code-and-documentation-format).
...
- Passing `WORKERS=1` as an environment variable to use a workerised setup instead. This option implies the use of Postgres.
  - If setting `WORKERS=1`, optionally set `WORKER_TYPES=` to declare which worker
    ...
    See the [worker documentation](Synapse%20Docs%20-%20EN/workers.md) for additional information on workers.
...
manage git [here](Synapse%20Docs%20-%20EN/development/git.md).
