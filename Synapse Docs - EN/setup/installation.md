...
[Setting up Federation](Synapse%20Docs%20-%20EN/federate.md).
...
the
[`enable_registration`](Synapse%20Docs%20-%20EN/usage/configuration/config_documentation.md#enable_registration)
setting.
...
a TURN server. See [TURN setup](Synapse%20Docs%20-%20EN/turn-howto.md) for details.
