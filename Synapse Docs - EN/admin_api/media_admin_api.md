...
are documented under [media repository](Synapse%20Docs%20-%20EN/media_repository.md).
...
the use of the
[List media uploaded by a user](Synapse%20Docs%20-%20EN/admin_api/user_admin_api.md#list-media-uploaded-by-a-user)
Admin API.
...
[User Admin API](Synapse%20Docs%20-%20EN/admin_api/user_admin_api.md#delete-media-uploaded-by-a-user).
