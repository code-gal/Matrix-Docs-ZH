...
solution to fix it is to use the [admin API](Synapse%20Docs%20-%20EN/usage/administration/admin_api/background_updates.md#run)
...
[configuration options](Synapse%20Docs%20-%20EN/usage/configuration/config_documentation.md#user_directory).
...
* If [ICU](https://en.wikipedia.org/wiki/International_Components_for_Unicode) is
  ...
  [installation instructions](Synapse%20Docs%20-%20EN/setup/installation.md) for how to install ICU.)
