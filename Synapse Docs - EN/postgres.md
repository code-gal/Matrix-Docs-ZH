...
The minimum supported version of PostgreSQL is determined by the [](Synapse%20Docs%20-%20EN/deprecation_policy.md).
...
-   If you are using the [](Synapse%20Docs%20-%20EN/setup/installation.md#matrixorg-packages), the necessary python
...
-   If you installed synapse [](Synapse%20Docs%20-%20EN/setup/installation.md#installing-as-a-python-module-from-pypi), you can install
    the library with:
