...
It is possible to configure Synapse to send a [](Synapse%20Docs%20-%20EN/server_notices.md) to anybody who has not yet agreed to the current
version of the policy. To do so:

 * ensure that the consent resource is configured, as in the previous section

 * ensure that server notices are configured, as in [the server notice documentation](Synapse%20Docs%20-%20EN/server_notices.md).
