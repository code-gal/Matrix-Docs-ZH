...
`opentracing.jaeger_config.local_agent.reporting_host` [in the Synapse configuration](Synapse%20Docs%20-%20EN/usage/configuration/config_documentation.md#opentracing-1)
...
documentation about how to do this in the [config manual under the header 'Opentracing'](Synapse%20Docs%20-%20EN/usage/configuration/config_documentation.md#opentracing).
